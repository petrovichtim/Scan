...
//    @Override
//    public int hashCode() {
//        int ip_custom = 0;//false;//= prefs.getBoolean(Prefs.KEY_IP_CUSTOM, Prefs.DEFAULT_IP_CUSTOM) ? 1 : 0;
//        int ip_start = "0.0.0.0".hashCode();//= prefs.getString(Prefs.KEY_IP_START, Prefs.DEFAULT_IP_START).hashCode();
//        int ip_end = "0.0.0.0".hashCode();
//        ;//= ;//prefs.getString(Prefs.KEY_IP_END, Prefs.DEFAULT_IP_END).hashCode();
...
//        return 42 + intf.hashCode() + ip.hashCode() + cidr.h + ip_custom + ip_start + ip_end + cidr_custom + cidr;
//    }
